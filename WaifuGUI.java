...
public class WaifuGUI extends JFrame implements KeyListener {
	...
	public WaifuGUI() {
		...
		JMenu waitype = new JMenu("Bot Test 1");
		menubar.add(waitype);
		JMenuItem tsun = new JMenuItem("Bot Test 2");
		tsun.addActionListener(new Tsunaction());
		waitype.add(tsun);
		/* JMenuItem kuu = new JMenuItem("Kuudere");
		kuu.addActionListener(new Kuuaction());
		waitype.add(kuu); */
		JMenuItem yan = new JMenuItem("Bot Test 3");
	...
	public void keyPressed(KeyEvent e) {
		if(e.getKeyCode()==KeyEvent.VK_ENTER){
			...
			String[] botName = {"Bot stupid 1","Bot stupid 2","Bot stupid 3"};
	...
	class chatBot implements ActionListener {
		public void actionPerformed (ActionEvent e) {
			answers = 0;
	...
	public String[][] chatBot() {
		...
		if (answers == 0) {
			String[][] tsun = {
					//Greetings
					{"Hello ", " Hi" , " Ohayo" ,"Greetings"},
					{"Hello you too ^_^ " , " Sawaddeeka " , " "},
					//How are you?
